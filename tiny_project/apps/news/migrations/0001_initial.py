...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Title that will appear on Facebook posts. This is limited to 100 characters, but Facebook will truncate the title to 88 characters.",
                        max_length=100,
                        verbose_name="title",
                    ),
                ),
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Description that will appear on Facebook posts. It is limited to 300 characters, but it is recommended that you do not use anything over 200.",
                        max_length=300,
                        verbose_name="description",
                    ),
                ),
                (
                    ...
                    models.IntegerField(
                        ...
                        default=None,
                        help_text='The type of content on the page. Most of the time "Summary" will suffice. Before you can benefit from any of these fields make sure to go to https://dev.twitter.com/docs/cards/validation/validator and get approved.',
                        null=True,
                        verbose_name="card",
                    ),
                ),
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Description that will appear on Twitter cards. It is limited to 200 characters. This does'nt effect SEO, so focus on copy that complements the tweet and title rather than on keywords.",
                        max_length=200,
                        verbose_name="description",
                    ),
                ),
                ...
                (
                    "image",
                    uncms.media.models.ImageRefField(
                        blank=True,
                        null=True,
        ...
        migrations.AddField(
            model_name="article",
            name="twitter_image",
            field=uncms.media.models.ImageRefField(
                blank=True,
                help_text='The minimum size it needs to be is 280x150. If you want to use a larger imagemake sure the card type is set to "Large Summary".',
                null=True,
                on_delete=django.db.models.deletion.PROTECT,
                related_name="+",
                to="media.File",
